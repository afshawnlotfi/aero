...
THREE.UTF8Loader.BufferGeometryCreator.prototype.create = function (
  attribArray,
  indices
) {
...
THREE.UTF8Loader.prototype.decompressAttribsInner_ = function (
  str,
  inputStart,
  inputEnd,
  output,
...
THREE.UTF8Loader.prototype.decompressIndices_ = function (
  str,
  inputStart,
  numIndices,
  output,
...
THREE.UTF8Loader.prototype.decompressAABBs_ = function (
  str,
  inputStart,
  numBBoxen,
  decodeOffsets,
...
THREE.UTF8Loader.prototype.decompressMesh = function (
  str,
  meshParams,
  decodeParams,
  name,
  ...
  if (bboxOffset) {
    bboxen = this.decompressAABBs_(
      str,
      bboxOffset,
      meshParams.names.length,
      decodeOffsets,
      decodeScales
    )
  }
...
THREE.UTF8Loader.prototype.copyAttrib = function (
  stride,
  attribsOutFixed,
  lastAttrib,
  index
...
THREE.UTF8Loader.prototype.decodeAttrib2 = function (
  str,
  stride,
  decodeOffsets,
  decodeScales,
...
THREE.UTF8Loader.prototype.accumulateNormal = function (
  i0,
  i1,
  i2,
  attribsOutFixed,
...
THREE.UTF8Loader.prototype.decompressMesh2 = function (
  str,
  meshParams,
  decodeParams,
  name,
  ...
  for (var i = 0; i < numIndices; i += 3) {
    ...
    if (code < max_backref) {
      ...
      if (code === 0) {
        for (var j = 0; j < 5; j++) {
          lastAttrib[j] =
            (attribsOutFixed[stride * index0 + j] +
              attribsOutFixed[stride * index1 + j]) /
            2
        }
...
THREE.UTF8Loader.prototype.downloadMesh = function (
  path,
  name,
  meshEntry,
  decodeParams,
...
THREE.UTF8Loader.prototype.downloadMeshes = function (
  path,
  meshUrlMap,
  decodeParams,
  callback
...
THREE.UTF8Loader.prototype.createMeshCallback = function (
  materialBaseUrl,
  loadModelInfo,
  allDoneCallback
) {
...
THREE.UTF8Loader.prototype.downloadModel = function (
  geometryBase,
  materialBase,
  model,
  callback
...
THREE.UTF8Loader.prototype.downloadModelJson = function (
  jsonUrl,
  callback,
  options
) {
