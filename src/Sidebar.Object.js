...
Sidebar.Object = function (editor) {
  ...
  var objectUUID = new UI.Input()
    ...
    .setFontSize("12px")
    .setDisabled(true)
  var objectUUIDRenew = new UI.Button("New")
    .setMarginLeft("7px")
    .onClick(function () {
  ...
  var objectName = new UI.Input()
    ...
    .onChange(function () {
      editor.execute(
        new SetValueCommand(editor.selected, "name", objectName.getValue())
      )
    })
  ...
  var objectParent = new UI.Select()
    .setWidth("150px")
    .setColor("#444")
    .setFontSize("12px")
    .onChange(update)
  ...
  var objectScaleLock = new UI.Checkbox(true)
    .setPosition("absolute")
    .setLeft("75px")
  var objectScaleX = new UI.Number(1)
    .setRange(0.01, Infinity)
    .setWidth("50px")
    .onChange(updateScaleX)
  var objectScaleY = new UI.Number(1)
    .setRange(0.01, Infinity)
    .setWidth("50px")
    .onChange(updateScaleY)
  var objectScaleZ = new UI.Number(1)
    .setRange(0.01, Infinity)
    .setWidth("50px")
  ...
  var objectReceiveShadow = new UI.THREE.Boolean(false, "receive").onChange(
    update
  )
  ...
  objectVisibleRow.add(objectVisible.setMarginLeft("-21px"))
  ...
  function update() {
    ...
    if (object !== null) {
      if (object.parent !== undefined) {
        ...
        if (object.parent.id !== newParentId && object.id !== newParentId) {
          ...
          try_set_parent(
            editor,
            object,
            editor.scene.getObjectById(newParentId, true)
          ) // DFH
      ...
      if (
        ...
        editor.execute(
          new SetValueCommand(object, "near", objectNear.getValue())
        )
      }
      ...
      if (
        ...
        editor.execute(
          new SetValueCommand(object, "intensity", objectIntensity.getValue())
        )
      }
      ...
      if (
        ...
        editor.execute(
          new SetColorCommand(object, "color", objectColor.getHexValue())
        )
      }
      ...
      if (
        ...
        editor.execute(
          new SetValueCommand(object, "distance", objectDistance.getValue())
        )
      }
      ...
      if (
        ...
        editor.execute(
          new SetValueCommand(object, "angle", objectAngle.getValue())
        )
      }
      ...
      if (
        ...
        editor.execute(
          new SetValueCommand(object, "penumbra", objectPenumbra.getValue())
        )
      }
      ...
      if (
        ...
        editor.execute(
          new SetValueCommand(object, "decay", objectDecay.getValue())
        )
      }

      if (object.visible !== objectVisible.getValue()) {
        editor.execute(
          new SetValueCommand(object, "visible", objectVisible.getValue())
        )
      }
      ...
      if (
        ...
        editor.execute(
          new SetValueCommand(object, "castShadow", objectCastShadow.getValue())
        )
      }
  ...
  function updateRows(object) {
    ...
    for (var property in properties) {
      properties[property].setDisplay(
        object[property] !== undefined ? "" : "none"
      )
    }
  }
  ...
  function updateUI(object) {
    ...
    if (object.angle !== undefined) {
      objectAngle.setValue(object.angle * THREE.Math.RAD2DEG)
    }
