...
Sidebar.Object = function ( editor ) {
	...
	var objectName = new UI.Input().setWidth( '150px' ).setFontSize( '12px' ).setValue('component name').onChange( function () {
	...
	function update() {
		...
		if ( object !== null ) {
			...
			var newRotation = new THREE.Euler( objectRotationX.getValue() * THREE.Math.DEG2RAD, objectRotationY.getValue() * THREE.Math.DEG2RAD, objectRotationZ.getValue() * THREE.Math.DEG2RAD,'ZYX');
	...
	signals.sceneGraphChanged.add( function () { //DFH
